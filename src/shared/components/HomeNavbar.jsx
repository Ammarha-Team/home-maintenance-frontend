      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          >
            ...
            <span className="absolute top-2 left-2.5 w-2.5 h-2.5 bg-emerald-500 rounded-full border-2 border-white" />
          </button>

          <div className="h-6 w-[1px] bg-blue-200" />
      ...
      {open && (
        <div className="md:hidden px-6 pb-5 pt-3 flex flex-col gap-4 text-gray-700 bg-white border-b border-gray-100">
          ...
          <div className="flex items-center justify-between pb-3 border-b border-gray-100 mb-2">
            ...
            <button
              onClick={() => setShowNotifications(true)}
              className="relative w-9 h-9 rounded-full bg-blue-50 flex items-center justify-center text-blue-600"
            >
              <Bell size={18} />

              <span className="absolute top-2 left-2 w-2 h-2 bg-emerald-500 rounded-full" />
            </button>
          </div>
